...
public class TtsDemo extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//改变默认的单行模式
		EditText ed = (EditText) findViewById(R.id.tts_text);
		...
		if (it!=null&&it.getExtras()!=null){
			...
			ed.setText(diary.getDiary_title()+"\r\n"+diary.getDiary_context());
			texts = "\u3000\u3000"+diary.getDiary_title()+"\r\n"+diary.getDiary_context();
			try{
				setParam();
				...
				.setSingleChoiceItems(mCloudVoicersEntries, // 单选框有几项,各是什么名字
					...
					public void onClick(DialogInterface dialog,
						...
						if ("catherine".equals(voicer) || "henry".equals(voicer) || "vimary".equals(voicer)) {
							 //((EditText) findViewById(R.id.tts_text)).setText("科大讯飞作为中国最大的智能语音技术提供商，在智能语音技术领域有着长期的研究积累");
						}else {
							//((EditText) findViewById(R.id.tts_text)).setText("科大讯飞作为中国最大的智能语音技术提供商，在智能语音技术领域有着长期的研究积累");
						}
						selectedNum = which;
